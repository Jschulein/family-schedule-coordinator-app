...
import { getUserFamilies, createFamily } from "@/services/families/simplifiedFamilyService";
...
export const SimpleFamilyProvider = ({ children }: FamilyProviderProps) => {
  ...
  // Fetch families with simplified approach
  ...
  const createFamilyHandler = async (name: string) => {
    ...
    // Set new family as active if available
    if (result.data) {
